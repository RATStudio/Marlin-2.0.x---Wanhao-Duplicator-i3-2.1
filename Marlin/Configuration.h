...
#define STRING_CONFIG_H_AUTHOR "(RATStudio)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp 12.50
    #define DEFAULT_Ki 1.52
    #define DEFAULT_Kd 25.65
  #endif
#endif // PIDTEMP
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 33.00
  #define DEFAULT_bedKi 290.00
  #define DEFAULT_bedKd 255.00
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 405.4591, 409 }
